...
export default function DoctorSignup() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020817] text-slate-900 dark:text-slate-50 flex flex-col relative overflow-hidden selection:bg-sky-500/30 transition-colors duration-300">
      {/* Background Effects */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-sky-500/5 dark:bg-sky-600/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-blue-500/5 dark:bg-blue-600/10 blur-[120px] pointer-events-none" />
      ...
      <main className="flex-grow flex items-center justify-center px-4 pt-8 pb-20 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-sky-100 dark:bg-sky-500/20 text-sky-600 dark:text-sky-400 mb-6 border border-sky-200 dark:border-sky-500/20 shadow-inner">
              <span className="material-symbols-outlined text-3xl">medical_services</span>
            </div>
            <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white mb-2">Doctor Registration</h1>
            <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">Join the HealthSync network to manage your clinical practice.</p>
          </div>
          ...
          <div className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-slate-800/60 rounded-3xl p-8 shadow-xl dark:shadow-2xl relative overflow-hidden">
              ...
              <motion.div variants={staggerContainer} initial="hidden" animate="show" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="name">Full Name (with Title)</label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500 pointer-events-none group-focus-within:text-sky-500 transition-colors">
                ...
                {/* Row 2: Specialization & Years Exp. */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="specialization">Specialization</label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500 pointer-events-none group-focus-within:text-sky-500 transition-colors">
                        <span className="material-symbols-outlined text-[20px]">stethoscope</span>
                      </div>
                      <select
                        className="w-full h-12 pl-11 pr-4 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-xl text-sm text-slate-900 dark:text-white focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all outline-none appearance-none font-medium"
                        id="specialization"
                        name="specialization"
                        required
                  ...
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="experience">Years Exp.</label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500 pointer-events-none group-focus-within:text-sky-500 transition-colors">
                ...
                {/* Row 3: Hospital Name & License No. */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="hospitalName">Hospital / Practice Name</label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500 pointer-events-none group-focus-within:text-sky-500 transition-colors">
                  ...
                  <motion.div variants={fadeUp} className="space-y-1.5">
                    <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="licenseNumber">License No.</label>
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400 dark:text-slate-500 pointer-events-none group-focus-within:text-sky-500 transition-colors">
                ...
                {/* Row 4: Upload License */}
                <motion.div variants={fadeUp} className="space-y-1.5">
                  <label className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 ml-1" htmlFor="licenseFile">Upload Medical License</label>
                  <div className="relative group flex items-center justify-center w-full">
                    <label htmlFor="licenseFile" className="flex flex-col items-center justify-center w-full h-12 border border-slate-200 dark:border-slate-800 border-dashed rounded-xl cursor-pointer bg-slate-50 dark:bg-slate-950/50 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors focus-within:ring-2 focus-within:ring-sky-500/50">
                      <div className="flex flex-col items-center justify-center px-4 overflow-hidden w-full whitespace-nowrap text-ellipsis">
                        <p className="text-sm font-medium text-slate-500 dark:text-slate-400 truncate w-full text-center">
                          {formData.licenseFile ? formData.licenseFile.name : <span className="flex items-center justify-center gap-2"><span className="material-symbols-outlined text-[18px]">upload_file</span> Upload PDF or Image</span>}
                        </p>
                      </div>
                      <input id="licenseFile" type="file" accept=".pdf,.jpg,.jpeg,.png" className="hidden" onChange={handleChange} required />
                    </label>
                  </div>
                </motion.div>
                      ...
                      <input
                        className={`w-full h-12 pl-11 pr-4 bg-slate-50 dark:bg-slate-950/50 border rounded-xl text-sm text-slate-900 dark:text-white focus:ring-2 transition-all outline-none placeholder:text-slate-400 dark:placeholder:text-slate-600 font-medium tracking-widest ${
                          formData.confirmPassword && formData.password !== formData.confirmPassword 
                            ...
                            : "border-slate-200 dark:border-slate-800 focus:border-sky-500/50 focus:ring-sky-500/50"
                        }`}
                        id="confirmPassword"
                        placeholder="••••••••"
                        required
            ...
            <div className="mt-8 flex items-center justify-center gap-2 border-t border-slate-200 dark:border-slate-800/60 pt-6">
              ...
              <Link href="/login?role=doctor" className="text-sm font-bold text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 transition-colors">
                Sign In
              </Link>
            </div>
          </div>
      ...
      {showOtpModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 backdrop-blur-sm bg-slate-900/60 transition-opacity">
          ...
          >
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-sky-100 dark:bg-sky-500/20 text-sky-600 dark:text-sky-400 mb-4">
            ...
            <div className="flex justify-between gap-3 mb-8">
              {[0, 1, 2, 3].map((index) => (
                <input
                  ...
                  type="text"
                  maxLength={1}
                  className="w-14 h-14 text-center text-2xl font-black bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 transition-all outline-none"
                  value={otp[index]}
