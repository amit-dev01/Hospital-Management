                      ...
                      <input
                        className={`w-full h-12 pl-11 pr-4 bg-slate-50 dark:bg-slate-950/50 border rounded-xl text-sm text-slate-900 dark:text-white focus:ring-2 transition-all outline-none placeholder:text-slate-400 dark:placeholder:text-slate-600 font-medium tracking-widest ${
                          formData.confirmPassword && formData.password !== formData.confirmPassword 
                            ...
                            : "border-slate-200 dark:border-slate-800 focus:border-emerald-500/50 focus:ring-emerald-500/50"
                        }`}
                        id="confirmPassword"
                        placeholder="••••••••"
                        required
                ...
                <motion.div variants={fadeUp} className="pt-4">
                  <button
                    ...
                    className={`w-full h-14 text-sm font-bold rounded-2xl flex items-center justify-center gap-2 transition-all duration-300 ${
                      isFormValid
                        ? "bg-gradient-to-r from-emerald-500 to-teal-400 text-white shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] active:scale-[0.98]"
            ...
            <div className="flex justify-between gap-3 mb-8">
              {[0, 1, 2, 3].map((index) => (
                <input
                  ...
                  type="text"
                  maxLength={1}
                  className="w-14 h-14 text-center text-2xl font-black bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all outline-none"
                  value={otp[index]}
